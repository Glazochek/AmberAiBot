...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Documents\programming\Neuronet Python\AmberAIBot\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Documents\programming\Neuronet Python\AmberAIBot\venv\Scripts\deactivate.nu'
